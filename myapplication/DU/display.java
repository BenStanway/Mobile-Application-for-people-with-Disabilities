...
import static com.example.myapplication.DU.PaintClass.paint_brush;
import static com.example.myapplication.DU.PaintClass.path;
...
public class display extends View {
    ...
    protected void onDraw(Canvas canvas) {
        for(int i = 0; i<pathList.size(); i ++){
            paint_brush.setColor(colourList.get(i));
